...
function ProfileView() {
  ...
  return (
    <>
      <HeadTags title="wehuddle profile - developer contributions" metaDescription="Visit my weHuddle profile and see my open source contributions so far"></HeadTags>
      <div>
          ...
          <div className="grid grid-cols-10 gap-4">
            ...
            <div className="col-span-6">
              <Card>
                ...
                <PRModalPrompt
                  show={isPRModalVisible}
                  onClose={onPRModalClose}
                />
                {pullRequest.length !== 0 && (
                  <div className="flex justify-end mt-5">
